...
<div class="login" id="logindiv" align="center">
  <div id="hidefocus">
  <%--<img src="<%=path%>/static/source/img/QQ_LOGIN.png" alt="QQ">--%>
  <h1>聊天系统</h1>
  </div>
  <form id="login-form" action="<%=path%>/user/login" method="post" onsubmit="return checkLoginForm()">
    <input type="text" name="userid" id="luserid" placeholder="用户名" required="required" onblur="showH()" onfocus="hideH()"/>
    <input type="password" name="password"  id="lpassword" placeholder="密码" required="required"onblur="showH()" onfocus="hideH()"/>
