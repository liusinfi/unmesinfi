...
<header data-am-widget="header"
    ...
    <h1 class="am-header-title">修改资料</h1>
</header>
<div class="admin-content" style="width: 100%;">
    <%--<div class="am-cf am-padding">
        ...
        <div class="am-tabs am-margin" style="margin: 0rem; " data-am-tabs>
                ...
                <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                    ...
                    <form class="am-form am-form-horizontal" id="information-form" action="${ctx}/update" method="post" data-am-validator>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-10">
                                <textarea class="" id="profile" name="profile" rows="3" placeholder="这里可以写下你的个性签名..."></textarea>
                            </div>
                            <script>
                ...
                <div class="am-tab-panel am-fade" id="tab2">
                    <form class="am-form am-form-horizontal" style="text-align: center;">
                        ...
                        <div class="am-form-group am-form-file">
                            ...
                            <input id="file" type="file" accept="image/*" name="file" onchange="checkFileType()">
                        </div>
...
<script>
    ...
    $('#profile').on('focus',function(event){
        //自动反弹 输入法高度自适应
        setTimeout(function() {
            $('body').scrollTop($('body')[0].scrollHeight);
        }, 1000);
